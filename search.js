export default async function handler(req, res) {
    ...
    const prompt = `
أنت مساعد توظيف محترف وخبير تحليل سير ذاتية متخصص في سوق العمل الكويتي.
...
### شرط إلزامي جداً:
- جميع الوظائف المقترحة يجب أن تكون **داخل دولة الكويت فقط**.
- لا تقترح أي وظيفة خارج الكويت.
- ركز على الشركات والقطاعات الموجودة في الكويت (البنوك، النفط والغاز، الحكومة، التعليم، الصحة، التجزئة، الخدمات المالية...).
...
<div class="bg-white rounded-2xl border border-slate-200 p-5 mb-4 shadow-sm">
  ...
  <p class="text-sm text-slate-600 mb-1"><strong class="text-slate-800">الموقع:</strong> الكويت</p>
  ...
  <div class="flex flex-wrap gap-2">
    ...
    <a href="رابط_جلف تالنت" target="_blank" class="text-xs bg-purple-50 text-purple-700 px-3 py-1.5 rounded-lg font-medium hover:bg-purple-100 transition">GulfTalent</a>
...
تعليمات مهمة جداً:
- أنشئ روابط بحث حقيقية وموجهة للكويت فقط.
- أمثلة صحيحة للروابط:
  - LinkedIn: https://www.linkedin.com/jobs/search/?keywords=Job%20Title&location=Kuwait
  - Bayt: https://www.bayt.com/en/kuwait/jobs/job-title-jobs/
  - GulfTalent: https://www.gulftalent.com/kuwait/jobs/search?keywords=Job+Title
  - Google Jobs: https://www.google.com/search?q=Job+Title+jobs+Kuwait&ibp=htl;jobs
- لا تستخدم مواقع غير مناسبة للكويت مثل Wuzzuf.
